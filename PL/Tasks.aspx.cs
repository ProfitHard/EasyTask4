...
namespace EasyTask4.PL
{
    public partial class Tasks : Page
    {
        ...
        protected async void gridTasks_RowUpdating(object sender, ASPxDataUpdatingEventArgs e)
        {
            ...
            // Получаем сервисы для поиска ID (предполагается, что у Вас есть StatusService и UserService)
            ...
            var updatedTask = new UserTask
            {
                ...
                Status = statusId.ToString(), // Ваша модель UserTask хранит Status как string, но в базе это int
