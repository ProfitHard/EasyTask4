<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tasks.aspx.cs" Inherits="EasyTask4.PL.Tasks" Async="true" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <dx:ASPxGridView ID="gridTasks" runat="server" OnRowInserting="gridTasks_RowInserting"
                OnRowUpdating="gridTasks_RowUpdating" OnRowDeleting="gridTasks_RowDeleting"
            ...
            <dx:ASPxButton ID="btnAddTask" runat="server" Text="Add New Task" AutoPostBack="False" OnClick="btnAddTask_Click" />
            <dx:ASPxButton ID="btnQueries" runat="server" Text="запрос задач за 7 дней" OnClick="btnQueries_Click" />
            <dx:ASPxButton ID="btnTaskCount" runat="server" Text="запрос количество статусов" OnClick="btnTaskCount_Click" />
        </div>
    </form>
